...
% خط زمان
\draw[timeline arrow] (0,0) -- (100,0);

% دوره‌ها
\fill[EraAncient, opacity=0.3] (0,-0.5) rectangle (20,0.5);
\fill[EraMedieval, opacity=0.3] (20,-0.5) rectangle (40,0.5);
\fill[EraEarlyMod, opacity=0.3] (40,-0.5) rectangle (60,0.5);
\fill[EraModern, opacity=0.3] (60,-0.5) rectangle (80,0.5);
\fill[EraContemp, opacity=0.3] (80,-0.5) rectangle (100,0.5);

% برچسب‌ها
\node[era label, fill=EraAncient] at (10, 1.2) {\rl{باستان}};
\node[era label, fill=EraMedieval] at (30, 1.2) {\rl{میانه}};
\node[era label, fill=EraEarlyMod] at (50, 1.2) {\rl{نوین اولیه}};
\node[era label, fill=EraModern] at (70, 1.2) {\rl{مدرن}};
\node[era label, fill=EraContemp] at (90, 1.2) {\rl{معاصر}};
...
\node[event node, below=1cm] at (75, -0.5)
  {\rl{جنگ‌های قاجار-روس}\\%
   \rl{۱۸۰۴--۱۸۲۸ م.}};

\node[event node, below=1cm] at (95, -0.5)
