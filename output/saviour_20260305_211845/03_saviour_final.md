---
source: "output\saviour_20260305_211845\01_converted.json"
...
# See: output\saviour_20260305_211845\code_blocks\code_block_001.tex
```
...
# See: output\saviour_20260305_211845\code_blocks\code_block_002.tex
```latex
%% ──────────────────────────────────────────────
...
\concept{سوگیری وضع موجود} (\lat{Status Quo Bias}) — بررسی‌شده در فصل~\ref{ch:social-psychology} — نشان می‌دهد که انسان‌ها ریسک تغییر را بیش از ریسک تداوم وضع موجود ارزیابی می‌کنند. شاید مخالفت با نجات‌طلبی نیز ت
```txt
# [Code extracted to: code_block_003.txt]
# See: output\saviour_20260305_211845\code_blocks\code_block_003.txt
```
